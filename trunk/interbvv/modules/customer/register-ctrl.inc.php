...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    if ( is_array($cfg["register"]["function"][$environment["kategorie"].",shared"]) ) {
        foreach ( $cfg["register"]["function"][$environment["kategorie"].",shared"] as $value ) {
            include $pathvars["moduleroot"]."libraries/function_".$value.".inc.php";
        }
    }

    // global function include loader
    if ( is_array($cfg["register"]["function"][$environment["kategorie"].",global"]) ) {
    ...
    if ( array_key_exists($environment["kategorie"], $cfg["register"]["function"]) ) {
        include $pathvars["moduleroot"].$cfg["leer"]["subdir"]."/".$cfg["leer"]["name"]."-".$environment["kategorie"].".inc.php";
    } else {
        include $pathvars["moduleroot"].$cfg["register"]["subdir"]."/".$cfg["register"]["name"].".inc.php";
    }
