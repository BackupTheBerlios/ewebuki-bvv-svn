...
//                 unset($_SESSION["file_memo"]);
        ...
        $ausgaben["form_aktion"] = $cfg["wizard"]["basis"]."/edit,".$environment["parameter"][1].",".$environment["parameter"][2].",".$environment["parameter"][3].",".$environment["parameter"][4].",,,verify.html";
        #$ausgaben["form_abbrechen"] = $_SESSION["page"];
        $ausgaben["form_break"] = $cfg["wizard"]["basis"]."/edit,".$environment["parameter"][1].",".$environment["parameter"][2].",".$environment["parameter"][3].",".$environment["parameter"][4].",,,unlock.html";
