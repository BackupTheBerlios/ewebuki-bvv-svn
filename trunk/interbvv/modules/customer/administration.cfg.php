...
////+///////+///////+///////+///////+///////+///////+///////////////////////////////////////////////////////////
    ...
    $cfg["admin"] = array(
           "subdir" => "customer",
             "name" => "leer",
            "basis" => $pathvars["virtual"], # crc = -1468826685 *
         "iconpath" => "/images/default/", # leer: /images/default/; automatik: $pathvars["images"]
            "color" => array(
                        "a" => "#eeeeee",
                        "b" => "#ffffff",
                       ),
         "function" => array(
                      "login" => array(""),
               "login,shared" => array("locate","make_ebene"),
                     "edit" => array(""),
                   "delete" => array(""),
                  "details" => array(""),
         ...
         "specials" => array(
             "/aktuell/archiv" => "artikel",
            "/aktuell/termine" => "termine",
             "/aktuell/presse" => "presse",
