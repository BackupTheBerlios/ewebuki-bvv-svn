...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            if ( is_array($hit) ) {
                ...
                foreach ( $hit as $key => $value ) {
                    ...
                    if ( $_POST["kate"] == "lokal" ) {
                        ...
                        if ( $value["kategorie"] != $_POST["kate"] ) continue;
                    }
    ...
    //                 if ( $halt == -1 ) break;
            ...
            if ( is_array($dataloop["lokal_".$bereich."_release_wait"]) )   uasort($dataloop["lokal_".$bereich."_release_wait"],'sort_marked_content');
                ...
                // lokale bereiche
                if ( is_array($dataloop["lokal_".$bereich."_edit"]) )  {
                    $hidedata["lokal_".$bereich."_edit"] = array();
                }
                if ( is_array($dataloop["lokal_".$bereich."_release_queue"]) )  {
                    $hidedata["lokal_".$bereich."_release_queue"] = array();
                } elseif ( is_array($dataloop["lokal_".$bereich."_release_wait"] ) )  {
                    $hidedata["lokal_".$bereich."_release_wait"] = array();
                }
                // globale bereiche
                ...
                $kate = "lokal";
                $id  = "lokal".$url;
                $ausgaben["lokal_".$bereich."_search"] = parser("administration-recent",'');
